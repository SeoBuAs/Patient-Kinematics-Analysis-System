...
class DeepLearningExperimentNoVIF:
    def __init__(self):
        self.results = {}
        self.final_models = {}
    ...
    def run_nested_cv_for_deep_model(self, model_name, model_info, X_train, y_train, X_val, y_val, X_test, y_test):
        logger.info(f"\n=== {model_name} deep learning model with fixed validation set (without VIF) ===")
    ...
    def run_complete_experiment(self):
        logger.info("=== Starting complete deep learning experiment with fixed validation set (without VIF) ===")
    ...
    def save_results(self):
        ...
        self.experiment_dir = f"results/deep_learning_experiment_no_vif_{timestamp}"
        os.makedirs(self.experiment_dir, exist_ok=True)
        self.save_models()
        self.save_csv_results()
        self.save_predictions()
        logger.info(f"Deep learning experiment results (without VIF) saved to {self.experiment_dir}.")
    ...
    def save_csv_results(self):
        ...
        summary_path = os.path.join(self.experiment_dir, "deep_model_summary_no_vif.csv")
        summary_df.to_csv(summary_path, index=False)
        logger.info(f"Deep learning model summary saved (without VIF): {summary_path}")
        for model_name, result in self.results.items():
            fold_data = []
...
if __name__ == "__main__":
    experiment = DeepLearningExperimentNoVIF()
    results = experiment.run_complete_experiment()
    logger.info("Complete deep learning experiment finished (without VIF)!") 